...
static_assert(std::is_copy_constructible<SerialDeviceConfiguration>::value,
              "SerialDeviceConfiguration needs to be copy constructible!");
...
public:
    explicit SerialDeviceLogToStream(const SerialDeviceConfiguration& serialDeviceConfiguration,
        ...
        SerialDevice(serialDeviceConfiguration), m_stream(stream) {
    }
